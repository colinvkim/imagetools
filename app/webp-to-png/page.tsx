        ...
        <header className="space-y-3 px-2">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-semibold tracking-tight text-balance">
              Fast WebP to PNG conversion, fully in the browser
            </h1>
            <p className="max-w-3xl text-base leading-7 text-muted-foreground sm:text-lg">
              This is the first real tool in the project and the foundation for
              the rest of the roadmap: upload, preview, process locally, and
              download.
            </p>
          </div>
        </header>
