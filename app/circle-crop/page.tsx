        ...
        <header className="space-y-3 px-2">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-semibold tracking-tight text-balance">
              Circle-crop images with a square editor and transparent PNG output
            </h1>
            <p className="max-w-3xl text-base leading-7 text-muted-foreground sm:text-lg">
              Position a square crop in the dialog, preview the result, and
              export a crisp circular image entirely in the browser.
            </p>
          </div>
        </header>
