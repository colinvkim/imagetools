...
export function SquareCropEditor({
  ...
  return (
    <div className={cn("w-full", className)}>
      <div className="overflow-hidden rounded-[1.25rem] border border-border/70 bg-[linear-gradient(45deg,transparent_25%,rgba(148,163,184,0.08)_25%,rgba(148,163,184,0.08)_50%,transparent_50%,transparent_75%,rgba(148,163,184,0.08)_75%)] bg-[length:24px_24px] p-3">
        <div className="flex justify-center rounded-[1rem] bg-background/85 p-2">
